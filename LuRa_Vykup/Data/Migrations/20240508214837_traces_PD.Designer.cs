...
namespace LuRa_Vykup.Data.Migrations
{
    ...
    [Migration("20240508214837_traces_PD")]
    partial class traces_PD
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LuRa_Vykup.Models.PokladniDoklady", b =>
                {
                    ...
                    b.Property<int>("IdDodavatelPokladna")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdDodavatelPokladna");
            ...
            modelBuilder.Entity("LuRa_Vykup.Models.PokladniDoklady", b =>
                {
                    ...
                    b.HasOne("LuRa_Vykup.Models.Dodavatele", "Dodavatele")
                        .WithMany()
                        .HasForeignKey("IdDodavatelPokladna")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
